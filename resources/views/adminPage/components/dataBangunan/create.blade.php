        ...
        <div class="col-lg-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/master/data-bangunan" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control @error('nama_bangunan') is-invalid @enderror" id="nama_bangunan" type="text"
                                name="nama_bangunan" value="{{ old('nama_bangunan') }}" required autocomplete="off">
                            @error('nama_bangunan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
