        ...
        <div class="col-lg-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/master/data-zona/{{ $zona->id }}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="mb-4">
                            <label for="nama_zona">Nama Zona</label>
                            <input class="form-control @error('nama_zona') is-invalid @enderror" id="nama_zona"
                                type="text" name="nama_zona" value="{{ old('nama_zona', $zona->nama_zona) }}" required
                                autocomplete="off">
                            @error('nama_zona')
                        ...
                        <div class="mb-4">
                            ...
                            @if ($zona->foto_zona)
                                <img src="{{ asset('storage/' . $zona->foto_zona) }}"
